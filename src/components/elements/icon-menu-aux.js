...
const mapStateToProps = state => {
    return { flagMenu: state.streams.flagMenu };
};

export default connect(mapStateToProps, { openMenu, setMenu })(IconMenu);
