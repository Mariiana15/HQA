            ...
            <div>
                <div className="sidebar left">
                    <div className="sidebar__icon sidebar__icon_on " id='home' onClick={() => { this.changeMenu('home') }}>
                        <div className='row '>
                            <div className='col-8'>
                                <div className='sub_menu_lateral'>
                            ...
                            <div className='col-8'>
                                <div className='sub_menu_lateral'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 34 34" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M24.1,13H7.9c-1.2,0-2.3-0.6-3-1.6L4,10l12-6l12,6l-0.9,1.4C26.4,12.4,25.3,13,24.1,13z" />
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.8,17.8c-0.6-0.7-1.2-1-1.8-0.8c-0.9,0.4-1.2,2-0.7,3.6c0.5,1.6,1.7,2.7,2.6,2.3c0,0,0.1,0,0.1-0.1c0.8,3.5,3.6,6.1,7,6.1s6.3-2.6,7-6.1c0,0,0.1,0.1,0.1,0.1c0.9,0.4,2.1-0.7,2.6-2.3C26.3,19,26,17.4,25,17c-0.6-0.2-1.3,0.1-1.8,0.8" />
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21.8,18H10.2C8.5,18,7,16.5,7,14.8V13h18v1.8C25,16.5,23.5,18,21.8,18z" />
                                    </svg>
                                </div>
                            </div>
                            <div className='col-1 '>
                    ...
                    <div className="sidebar__icon" id='integrations' onClick={() => { this.changeMenu('integrations') }}>
                        <div className='row '>
                            <div className='col-8'>
                                <div className='sub_menu_lateral'>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 90 90" stroke="currentColor">
